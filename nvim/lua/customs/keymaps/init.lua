...
displayKeymap("n", {desc='Goto number[=1] line' }, "gk", "gg0zz")
displayKeymap("n", {desc='Goto last line'       }, "gj", "G0zz")
displayKeymap("n", {desc='Goto top screen'      }, "gt", "H0")
displayKeymap("n", {desc='Goto center screen'   }, "gc", "M0")
displayKeymap("n", {desc='Goto bottom screen'   }, "gb", "L0")
displayKeymap("n", {desc='Goto first character' }, "gs", "_")
displayKeymap("n", {desc='Goto last character'  }, "ge", "g_")
displayKeymap("n", {desc='Goto first column'    }, "gh", "0")
displayKeymap("n", {desc='Goto last column'     }, "gl", "$")
displayKeymap("n", {desc='Goto middle character'}, "gm", "gM")
displayKeymap("n", {desc='Goto ???'             }, "gM", "gm")
displayKeymap("n", {silent=true, desc='Goto next buffer'    }, "gn", ":bnext<cr>zz")
displayKeymap("n", {silent=true, desc='Goto previous buffer'}, "gp", ":bprevious<cr>zz")
displayKeymap("v", {desc='Goto number[=1] line' }, "gk", "gg0zz")
displayKeymap("v", {desc='Goto last line'       }, "gj", "G0zz")
displayKeymap("v", {desc='Goto top screen'      }, "gt", "H0")
displayKeymap("v", {desc='Goto center screen'   }, "gc", "M0")
displayKeymap("v", {desc='Goto bottom screen'   }, "gb", "L0")
displayKeymap("v", {desc='Goto first character' }, "gs", "_")
displayKeymap("v", {desc='Goto last character'  }, "ge", "g_")
displayKeymap("v", {desc='Goto first column'    }, "gh", "0")
displayKeymap("v", {desc='Goto last column'     }, "gl", "$")
displayKeymap("v", {desc='Goto middle character'}, "gm", "gM")
displayKeymap("v", {desc='Goto ???'             }, "gM", "gm")
displayKeymap("v", {silent=true, desc='Goto next buffer'    }, "gn", "<esc>:bnext<cr>zzv")
displayKeymap("v", {silent=true, desc='Goto previous buffer'}, "gp", "<esc>:bprevious<cr>zzv")
