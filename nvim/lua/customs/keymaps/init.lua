...
displayKeymap("n", {desc='Move left unit' }, "<C-h>", unit.."zh")
displayKeymap("n", {desc='Move right unit'}, "<C-l>", unit.."zl")
displayKeymap("n", {desc='Move left unit' }, "<C-j>", unit.."<C-e>")
displayKeymap("n", {desc='Move right unit'}, "<C-k>", unit.."<C-y>")
displayKeymap("v", {desc='Move left unit' }, "<C-h>", unit.."zh")
displayKeymap("v", {desc='Move right unit'}, "<C-l>", unit.."zl")
