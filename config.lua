...
lvim.keys.normal_mode["<C-q>"] = ":xa<CR>"
lvim.keys.normal_mode["<C-h>"] = "^"
lvim.keys.normal_mode["<C-j>"] = "jzz"
lvim.keys.normal_mode["<C-k>"] = "kzz"
...
lvim.keys.normal_mode["<Tab>"] = ":bnext<CR>zz"
lvim.keys.normal_mode["<S-Tab>"] = ":bprevious<CR>zz"
...
lvim.keys.visual_mode["<C-j>"] = ":m'>+<CR>gv"
lvim.keys.visual_mode["<C-k>"] = ":m-2<CR>gv"
lvim.keys.visual_mode["<C-l>"] = "$"
lvim.keys.visual_mode["("] = "s()<ESC>hpl%"
lvim.keys.visual_mode[")"] = "s(  )<ESC>hhpll%"
lvim.keys.visual_mode["{"] = "s{}<ESC>hpl%"
lvim.keys.visual_mode["}"] = "s{  }<ESC>hhpll%"
lvim.keys.visual_mode["<A-[>"] = "s[]<ESC>hpl%"
lvim.keys.visual_mode["<A-]>"] = "s[  ]<ESC>hhpll%"
lvim.keys.visual_mode["<"] = "s<><ESC>hp"
lvim.keys.visual_mode[">"] = "s<  ><ESC>hhp"
lvim.keys.visual_mode["'"] = "s''<ESC>hp"
lvim.keys.visual_mode["\""] = "s\"\"<ESC>hp"
